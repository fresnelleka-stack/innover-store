          ...
          <table className="w-full">
            <thead className="bg-gray-100 border-b">
              <tr>
                ...
                <th className="px-6 py-3 text-right text-sm font-semibold text-gray-900">Vendu</th>
                ...
                products.map((p) => {
                  ...
                  return (
                    <tr key={p.id} className="border-b hover:bg-gray-50">
                      <td className="px-6 py-3 text-sm font-medium text-gray-900">{p.sku}</td>
                      ...
                      <td className="px-6 py-3 text-sm text-right text-gray-900">{p.quantity_available}</td>
                      <td className="px-6 py-3 text-sm text-right text-gray-900">{p.quantity_sold || 0}</td>
